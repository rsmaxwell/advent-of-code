...
func GetLinesWidth(lines []string) (int, int) {
...
func GetReportConstantWidth(filename string) (int, error) {
	...
	minimum, maximum := GetLinesWidth(lines)
	if minimum != maximum {
...
func GetReportWidth(filename string) (int, int, error) {
